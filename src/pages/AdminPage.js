...
{/*Booking Management Tab*/}
  ...
  <div className="stats-cards">
    <div className="card">Rooms Booked: <strong>85</strong></div>
    <div className="card">Rooms Available: <strong>35</strong></div>
    <div className="card">Upcoming Check-ins: <strong>15</strong></div>
    <div className="card">Upcoming Check-outs: <strong>8</strong></div>
              ...
              <div className="chart-box">
               <h3>Rooms Status</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={roomsStatusData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
...
{/*Facilities Chart*/}
          <div className="chart-placeholder"><div className="chart-box">
            ...
            >
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="name" label={{ value: "Facilities", position: "bottom", offset: 10 }} />
              <YAxis label={{ value: "No. of Bookings", angle: -90, position: "insideLeft" }} />
              <Tooltip />
...
{activeTab === "analytics" && (
  <div className="stats-wrapper">
    <div className="stats-cards">
      <div className="card">Total Visits: <strong>300</strong></div>
      <div className="card">New Users Today: <strong>35</strong></div>
      <div className="card">Active Users: <strong>15</strong></div>
      <div className="card">Returning Users: <strong>56</strong></div>
    </div>
    ...
    <div className="charts">
      <div className="chart-placeholder">
        <div className="chart-box">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie dataKey="value" data={trafficData} cx="50%" cy="50%" outerRadius={100} fill="#1E3A8A" label />
              <Tooltip />
            </PieChart>
          </ResponsiveContainer>
        </div>
