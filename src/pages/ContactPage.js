    ...
    <div className="main-content">
      ...
      <div className="brown-box-content">
        ...
        <p>
          ...
          <br /><br />
          For any additional information about our luxury hotel in Mellieha, Malta, we are happy to assist.
          Located in one of Malta's most picturesque coastal areas. The Opulence offers breathtaking views and world-class hospitality.
          <br /><br />
      ...
      <div className="details-section">
        ...
        <div className="details-content">
          <p><span className="details-label">Phone</span> <span className="details-text">+356 2784 3647</span></p>
          <p><span className="details-label">Email Address</span> <span className="details-text">info@thepolulence.com.mt</span></p>
          <p><span className="details-label">Location</span> <span className="details-text">57, Seaview Street, Mellieha, Malta</span></p>
        </div>
      </div>
    </div>
  );
